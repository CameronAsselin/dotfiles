...
alias chat='ollama serve & > ~/.ollama/cache/ollama_serve_start; ollama pull hf.co/HauhauCS/Qwen3.5-9B-Uncensored-HauhauCS-Aggressive; ollama run hf.co/HauhauCS/Qwen3.5-9B-Uncensored-HauhauCS-Aggressive; killall ollama'
# Changing "ls" to "exa"
