...
alias chat='sudo systemctl start ollama; ollama pull hf.co/HauhauCS/Qwen3.5-9B-Uncensored-HauhauCS-Aggressive; ollama run hf.co/HauhauCS/Qwen3.5-9B-Uncensored-HauhauCS-Aggressive; sudo systemctl stop ollama'
# Changing "ls" to "exa"
